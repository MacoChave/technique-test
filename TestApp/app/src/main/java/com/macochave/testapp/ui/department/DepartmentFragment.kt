...
import com.macochave.testapp.databinding.FragmentDepartmentBinding
...
class DepartmentFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val departmentViewModel =
                ViewModelProvider(this).get(DepartmentViewModel::class.java)

        _binding = FragmentDepartmentBinding.inflate(inflater, container, false)
        val root: View = binding.root

        val textView: TextView = binding.textDashboard
        departmentViewModel.text.observe(viewLifecycleOwner) {
            textView.text = it
        }
        return root
    }
